...
const kColorBlue = Color(0xff778BEB);
const kColorSubButton = Color(0xffDBDFFD);
const kColorButton = Color(0xffFFE5B4);
...
TextStyle textSubtitle = GoogleFonts.inter(fontWeight: regular, fontSize: 18);
